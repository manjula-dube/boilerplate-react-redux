...
module.exports = {
  ...
  entry: {
    main: './movies-client/index.js',
    vendor: './movies-client/vendor.js',
    landing: './movies-client/containers/LandingPage/LandingPage.js',
  },
  ...
  plugins: [
    ...
    ...ifProd([
      ...
      new CopyWebpackPlugin([
        { from: './movies-client/manifest.json' },
        { from: './movies-client/offline', to: 'offline/[name].1a2b3c4d.[ext]' },
      ], { copyUnmodified: true }),
